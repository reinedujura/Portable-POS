...
# Add parent (project root) to path FIRST for backend imports
sys.path.insert(0, str(Path(__file__).parent.parent))

from backend.database.mongodb import DatabaseManager  # Import our database manager
from datetime import datetime  # For timestamps

from backend.models.menu import MENU_CATEGORIES  # Import menu categories for dropdown
from backend.models.transaction import TransactionItem  # Import transaction models
